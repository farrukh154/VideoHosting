...
<script>
    ...
    function displayResults(videos) {
        ...
        videos.forEach(video => {
            ...
            videoElement.className = 'mb-3';
            videoElement.innerHTML = `
                <h5 class="text-white fw-bold">${video.title}</h5>
                <iframe width="320" height="240" src="https://www.youtube.com/embed/${video.id}" frameborder="0" allowfullscreen></iframe>
            `;
